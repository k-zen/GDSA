...
- (void)loadView
{
    ...
    self.logoImage = [[UIImageView alloc] initWithFrame:CGRectMake(20, 30, 64, 64)];
    self.logoImage.image = [UIImage imageNamed:@"0034-128px.png"];
    
    self.blurView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)];
    
    self.backgroundView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)];
    self.backgroundView.image = [UIImage imageNamed:@"0042-000px.png"];
...
- (void)viewDidLoad
{
    ...
    if ([self.options[AMOptionsUseBorderedButton] boolValue]) {
        ...
        button.imageEdgeInsets = UIEdgeInsetsMake(10, 8, 10, 12);
...
- (void)toggleMenu
{
    // [[NSNotificationCenter defaultCenter] postNotificationName:kTAP_VIEW object: nil];
